...
<head>
    <meta charset="utf-8" />
    <title>@yield('title') | {{ $appBrand['name'] ?? config('app.name') }}</title>
    <!--begin::Fonts-->
            ...
            <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
                ...
                <div class="brand flex-column-auto" id="kt_brand">
                    ...
                    <a href="{{ url('/') }}" class="brand-logo">
                        <img alt="{{ $appBrand['name'] ?? 'Logo' }}" src="{{ $appBrand['logo_url'] ?? asset('admin/assets/media/logos/logo-light.png') }}" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Toggle-->
                            ...
                            <div class="topbar-item">
                                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                                    ...
                                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                                        <span
                                            class="symbol-label font-size-h5 font-weight-bold">{{ \Illuminate\Support\Str::upper(\Illuminate\Support\Str::substr(trim(auth()->user()?->name ?? ''), 0, 1)) ?: '؟' }}</span>
                                    </span>
                                </div>
                            </div>
                            <!--end::User-->
        ...
        <div class="offcanvas-content pr-5 mr-n5">
            ...
            <div class="d-flex align-items-center mt-5">
                <div class="symbol symbol-100 mr-5">
                    <div class="symbol-label" style="background-image:url('{{ asset('admin/assets/media/users/300_21.jpg') }}')"></div>
