...
@section('title', __('locations.governorates_title'))
...
@section('breadcrumbs')
    ...
    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
        ...
        <li class="breadcrumb-item text-muted">{{ __('locations.governorates_title') }}</li>
    </ul>
@endsection
    ...
    <div class="card card-custom">
        <div class="card-header py-5">
            <div class="card-title">
                <h3 class="card-label">{{ __('locations.governorates_title') }}</h3>
            </div>
            <div class="card-toolbar">
                <a href="{{ route('admin.governorates.create') }}" class="btn btn-primary font-weight-bolder">
                    <i class="la la-plus ml-1"></i>{{ __('locations.add_governorate') }}
                </a>
            </div>
        </div>
        <div class="card-body">
