    ...
    var t = function (t) {
        ...
        e &&
            KTUtil.on(e, "thead th .checkbox > input", "change", function (t) {
                for (
                    var o = KTUtil.findAll(e, "tbody td .checkbox > input"),
                        s = 0,
                        a = o.length;
                    s < a;
                    s++
            ...
            !(function () {
                ...
                function s(t, e, o) {
                    var s = "",
                        a = "";
                    e - t < 100 || "Today" == o
                        ? ((s = "Today:"), (a = t.format("MMM D")))
                        : "Yesterday" == o
                        ? ((s = "Yesterday:"), (a = t.format("MMM D")))
                        : (a = t.format("MMM D") + " - " + e.format("MMM D")),
                    ...
                    if (t) {
                        var s = {
                            ...
                            stroke: {
                                ...
                                width: 3,
                                colors: [
                                    KTApp.getSettings().colors.theme.base[o],
                                ],
                            },
                            xaxis: {
                                categories: [
                            ...
                            markers: {
                                colors: [
                                    KTApp.getSettings().colors.theme.light[o],
                                ],
                                strokeColor: [
                                    KTApp.getSettings().colors.theme.base[o],
                                ],
                    ...
                    if (t) {
                        var o = {
                            ...
                            stroke: {
                                ...
                                width: 3,
                                colors: [
                                    KTApp.getSettings().colors.theme.base[e],
                                ],
                            },
                            xaxis: {
                                categories: [
                            ...
                            markers: {
                                colors: [
                                    KTApp.getSettings().colors.theme.light[e],
                                ],
                                strokeColor: [
                                    KTApp.getSettings().colors.theme.base[e],
                                ],
                ...
                (function () {
                    ...
                    if (t) {
                        var e = {
                            ...
                            grid: {
                                borderColor:
                                    KTApp.getSettings().colors.gray["gray-200"],
                                strokeDashArray: 4,
                                yaxis: { lines: { show: !0 } },
                            },
                        };
                            ...
                            s = {
                                ...
                                xaxis: {
                                    ...
                                    labels: {
                                        show: !1,
                                        style: {
                                            colors: KTApp.getSettings().colors
                                                .gray["gray-500"],
                                            fontSize: "12px",
                                            fontFamily:
                                                KTApp.getSettings()[
                                    ...
                                    crosshairs: {
                                        ...
                                        position: "front",
                                        stroke: {
                                            color: KTApp.getSettings().colors
                                                .gray["gray-300"],
                                            width: 1,
                                            dashArray: 3,
                                        },
                        ...
                        var o = {
                            ...
                            plotOptions: {
                                radialBar: {
                                    ...
                                    track: {
                                        background:
                                            KTApp.getSettings().colors.theme
                                                .light.success,
                                        strokeWidth: "100%",
                                    },
                                },
                ...
                (function () {
                    var t = document.getElementById("kt_tiles_widget_2_chart"),
                        e = parseInt(KTUtil.css(t, "height"));
                    if (t) {
                        var o = KTUtil.changeColor(
                                KTApp.getSettings().colors.theme.base.danger
                            ),
                            s = KTUtil.changeColor(
                                KTApp.getSettings().colors.theme.base.danger
                            ),
                            a = {
                                series: [
                ...
                (function () {
                    ...
                    if (t) {
                        var e = {
                            series: [
                                { name: "Net Profit", data: [10, 20, 20, 8] },
                            ],
                            chart: {
                                type: "area",
                                height: 150,
                ...
                (function () {
                    ...
                    if (t) {
                        var e = {
                            ...
                            colors: [
                                KTApp.getSettings().colors.theme.inverse
                                    .primary,
                            ],
                            stroke: { lineCap: "round" },
                            labels: ["Progress"],
                ...
                (e = "kt_price_slider"),
                void 0 !== (o = document.getElementById(e)) &&
                    o &&
                    noUiSlider.create(o, {
                        start: [20, 60],
                        connect: !0,
                ...
                (s = KTUtil.getById("kt_forms_widget_1_input")) && autosize(s),
                KTUtil.getById("kt_forms_widget_2_form") &&
                    new Quill("#kt_forms_widget_2_editor", {
                        modules: {
                            toolbar: {
                ...
                (a = KTUtil.getById("kt_app_education_more_feeds_btn")) &&
                    KTUtil.addEvent(a, "click", function (t) {
                        ...
                        !e ||
                            ...
                            setTimeout(function () {
                                var t;
                                KTUtil.btnRelease(a),
                                    KTUtil.addClass(a, "d-none");
                                for (var o = 0, s = e.length; o < s; o++) {
                                    (t = e[0]),
                                        KTUtil.removeClass(e[o], "d-none");
