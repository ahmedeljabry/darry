...
var KTWidgets = (function () {
    ...
    var _initStatsWidget10 = function () {
        ...
        var options = {
            ...
            markers: {
                colors: [
                    KTApp.getSettings()["colors"]["theme"]["light"][color],
                ],
                strokeColor: [
                    KTApp.getSettings()["colors"]["theme"]["base"][color],
                ],
                strokeWidth: 3,
            },
        };
        ...
        var options = {
            ...
            xaxis: {
                ...
                crosshairs: {
                    position: "front",
                    stroke: {
                        color: KTApp.getSettings()["colors"]["theme"]["base"][
                            "info"
                        ],
                        width: 1,
                        dashArray: 3,
        ...
        var options = {
            ...
            xaxis: {
                ...
                crosshairs: {
                    position: "front",
                    stroke: {
                        color: KTApp.getSettings()["colors"]["theme"]["light"][
                            "success"
                        ],
                        width: 1,
                        dashArray: 3,
    ...
    var _initMixedWidget3 = function () {
        ...
        var strokeColor =
            KTApp.getSettings()["colors"]["theme"]["base"]["white"];
        ...
        var options = {
            ...
            markers: {
                colors: [
                    KTApp.getSettings()["colors"]["theme"]["light"]["dark"],
                ],
                strokeColor: [strokeColor],
                strokeWidth: 3,
            },
    ...
    var _initTilesWidget2 = function () {
        ...
        var strokeColor = KTUtil.changeColor(
            KTApp.getSettings()["colors"]["theme"]["base"]["danger"]
        );
        var fillColor = KTUtil.changeColor(
            KTApp.getSettings()["colors"]["theme"]["base"]["danger"]
        );
            ...
            plotOptions: {
                radialBar: {
                    ...
                    dataLabels: {
                        ...
                        value: {
                            color: KTApp.getSettings()["colors"]["theme"][
                                "inverse"
                            ]["primary"],
                            fontSize: "22px",
                            fontWeight: "bold",
                    ...
                    track: {
                        background: KTUtil.changeColor(
                            KTApp.getSettings()["colors"]["theme"]["base"][
                                "primary"
                            ],
                            -7
                        ),
    ...
    var _initAdvancedTableGroupSelection = function (element) {
        ...
        KTUtil.on(table, "thead th .checkbox > input", "change", function (e) {
            var checkboxes = KTUtil.findAll(
                table,
                "tbody td .checkbox > input"
            );
