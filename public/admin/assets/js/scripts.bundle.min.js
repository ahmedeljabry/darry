            ...
            l = {
                ...
                remove: function () {
                    ...
                    !1 !== l.eventTrigger("beforeRemove") &&
                        ((t = document.querySelectorAll(".tooltip.show")) &&
                            $(t).tooltip("dispose"),
                        KTUtil.remove(n),
                ...
                collapse: function () {
                    !1 !== l.eventTrigger("beforeCollapse") &&
                        (KTUtil.slideUp(
                            a.body,
                            a.options.toggleSpeed,
                            function () {
                ...
                build: function () {
                    ...
                    window.addEventListener("scroll", function () {
                        ...
                        (KTUtil.isBreakpointDown("lg") &&
                            ...
                            (KTUtil.isBreakpointUp("lg") &&
                                a.options.releseOnReverse.desktop)
                                ? (n > o && e < n
                                      ? (!1 ===
                                            i.hasAttribute(
                                                "data-header-scroll"
                                      ...
                                      : (!0 ===
                                        ...
                                        0 == t &&
                                            (l.eventTrigger("scrollOff", a),
                                            (t = !0))),
                                  (e = n))
                                : n > o
                                ? (!1 ===
                                      i.hasAttribute("data-header-scroll") &&
                                      i.setAttribute(
                                          "data-header-scroll",
                                          "on"
                                      ),
                                  t &&
                                      (l.eventTrigger("scrollOn", a), (t = !1)))
                                : (!0 ===
                                      i.hasAttribute("data-header-scroll") &&
        ...
        var l = {
            ...
            r = {
                ...
                resetSubmenuProps: function (t) {
                    ...
                    if (e)
                        for (var a = 0, n = e.length; a < n; a++) {
                            var o = e[0];
                            KTUtil.css(o, "display", ""),
                                KTUtil.css(o, "overflow", ""),
                                o.hasAttribute("data-hor-direction") &&
                                    (KTUtil.removeClass(o, "menu-submenu-left"),
                                    KTUtil.removeClass(o, "menu-submenu-right"),
                                    KTUtil.addClass(
                                        o,
                                        o.getAttribute("data-hor-direction")
                                    ));
                        }
                },
                ...
                handleSubmenuDropdownClick: function (t) {
                    if ("accordion" !== r.getSubmenuMode(this)) {
                        ...
                        !1 !== r.eventTrigger("submenuToggle", this, t) &&
                            "accordion" !=
                                e.getAttribute("data-menu-submenu-mode") &&
                ...
                handleSubmenuAccordion: function (t, e) {
                    ...
                    if (!1 !== r.eventTrigger("submenuToggle", this, t))
                        if (
                            ...
                            "accordion" !=
                                n.getAttribute("data-menu-submenu-mode")
                        )
                            t.preventDefault();
                        else {
                            ...
                            if (
                                ...
                                if (
                                    !1 === KTUtil.hasClass(o, "menu-item-open")
                                ) {
                ...
                resetActiveItem: function (t) {
                    for (
                        var e,
                            n,
                            o = 0,
                            l = (e = i.querySelectorAll(".menu-item-active"))
                                .length;
                        o < l;
                        o++
                    ) {
                        ...
                        for (
                            var s = 0,
                                d = (n =
                                    KTUtil.parents(r, ".menu-item-submenu") ||
                                    []).length;
                            s < d;
                            s++
                        ) {
                ...
                getBreadcrumbs: function (t) {
                    ...
                    a.push({
                        text: (e = KTUtil.child(n, ".menu-text")
                            ? e.innerHTML
                            : ""),
                    ...
                    for (
                        ...
                        a.push({
                            text: (e = KTUtil.child(r, ".menu-text")
                                ? e.innerHTML
                                : ""),
            ...
            l = {
                ...
                toggle: function () {
                    l.eventTrigger("toggle"),
                        "shown" == a.state ? l.hide() : l.show();
                },
                show: function () {
                    "shown" != a.state &&
                        (l.eventTrigger("beforeShow"),
                        l.toggleClass("show"),
                        KTUtil.attr(i, "data-offcanvas-" + a.classBase, "on"),
                        KTUtil.addClass(n, a.classShown),
                        a.attrCustom.length > 0 &&
                            KTUtil.attr(
                                i,
                                "data-offcanvas-" + a.classCustom,
                                "on"
                            ),
                        (a.state = "shown"),
                        a.options.overlay &&
                ...
                hide: function () {
                    "hidden" != a.state &&
                        ...
                        l.toggleClass("hide"),
                        KTUtil.removeAttr(i, "data-offcanvas-" + a.classBase),
                        KTUtil.removeClass(n, a.classShown),
                        a.attrCustom.length > 0 &&
                            KTUtil.removeAttr(
                                i,
                                "data-offcanvas-" + a.attrCustom
                            ),
                        (a.state = "hidden"),
                        a.options.overlay &&
                            a.overlay &&
                ...
                toggleClass: function (t) {
                    ...
                    if (
                        ...
                        for (var i in a.options.toggleBy)
                            a.options.toggleBy[i].target === n &&
                                (e = a.options.toggleBy[i]);
                    else
                        a.options.toggleBy &&
                            a.options.toggleBy.target &&
...
var KTToggle = function (t, e, a) {
    var n = this,
        ...
        o = e;
    if (i) {
        var l = { targetToggleMode: "class" },
            r = {
                construct: function (t) {
                    return (
                        KTUtil.data(i).has("toggle")
                            ? (n = KTUtil.data(i).get("toggle"))
                            : (r.init(t),
                              r.build(),
                              KTUtil.data(i).set("toggle", n)),
                        n
                    );
                },
                init: function (t) {
                    (n.element = i),
                        (n.events = []),
                        (n.options = KTUtil.deepExtend({}, l, t)),
                        (n.target = o),
                        (n.targetState = n.options.targetState),
                        (n.toggleState = n.options.toggleState),
                        "class" == n.options.targetToggleMode
                            ? (n.state = KTUtil.hasClasses(
                                  n.target,
                                  n.targetState
                              )
                                  ? "on"
                                  : "off")
                            : (n.state = KTUtil.hasAttr(
                                  n.target,
                                  "data-" + n.targetState
                              )
                                  ? KTUtil.attr(
                ...
                toggle: function (t) {
                    return (
                        r.eventTrigger("beforeToggle"),
                        "off" == n.state ? r.toggleOn() : r.toggleOff(),
                        r.eventTrigger("afterToggle"),
                        t.preventDefault(),
                        n
                    );
                },
                toggleOn: function () {
                    return (
                        r.eventTrigger("beforeOn"),
                        "class" == n.options.targetToggleMode
                            ? KTUtil.addClass(n.target, n.targetState)
                            : KTUtil.attr(
                                  n.target,
                                  "data-" + n.targetState,
                                  "on"
                              ),
                        n.toggleState && KTUtil.addClass(i, n.toggleState),
                        (n.state = "on"),
                        r.eventTrigger("afterOn"),
                        r.eventTrigger("toggle"),
                        n
                    );
                },
                toggleOff: function () {
                    return (
                        r.eventTrigger("beforeOff"),
                        "class" == n.options.targetToggleMode
                            ? KTUtil.removeClass(n.target, n.targetState)
                            : KTUtil.removeAttr(
                                  n.target,
                                  "data-" + n.targetState
                              ),
                        n.toggleState && KTUtil.removeClass(i, n.toggleState),
                        (n.state = "off"),
                        r.eventTrigger("afterOff"),
                        r.eventTrigger("toggle"),
                        n
                    );
                },
...
"undefined" != typeof module &&
    ...
    null == Element.prototype.getAttributeNames &&
        (Element.prototype.getAttributeNames = function () {
            for (
                var t = this.attributes, e = t.length, a = new Array(e), n = 0;
                n < e;
                n++
            )
                a[n] = t[n].name;
...
var KTUtil = (function () {
    ...
    return {
        ...
        isMobileDevice: function () {
            ...
            return (
                !1 === t && (t = null != navigator.userAgent.match(/iPad/i)), t
            );
        },
            ...
            for (var e, a; t && t !== document; ) {
                if (
                    ("absolute" === (e = KTUtil.css(t, "position")) ||
                        "relative" === e ||
                        "fixed" === e) &&
                    ((a = parseInt(KTUtil.css(t, "z-index"))),
                    !isNaN(a) && 0 !== a)
                )
                    return a;
                t = t.parentNode;
            ...
            for (var e = 1; e < arguments.length; e++) {
                ...
                if (a)
                    for (var n in a)
                        a.hasOwnProperty(n) &&
                            ("[object Object]" !==
                            Object.prototype.toString.call(a[n])
                                ? (t[n] = a[n])
        ...
        data: function (t) {
            return {
                ...
                remove: function (e) {
                    t &&
                        this.has(e) &&
                        delete window.KTUtilElementDataStore[t.customDataTag][
                            e
                        ];
                },
            };
                    ...
                    !1 !==
                        (n =
                            e.height instanceof Function
                                ? e.height.call()
                                : !0 === KTUtil.isMobileDevice() &&
                                  e.mobileHeight
                                ? parseInt(e.mobileHeight)
                                : e.height
                                ? parseInt(e.height)
        ...
        btnWait: function (t, e, a, n) {
            if (
                ...
                e && (KTUtil.addClass(t, e), KTUtil.attr(t, "wait-class", e)),
                a)
            ) {
                var i = KTUtil.find(t, ".btn-caption");
                i
                    ? (KTUtil.data(i).set("caption", KTUtil.getHTML(i)),
                      KTUtil.setHTML(i, a))
                    : (KTUtil.data(t).set("caption", KTUtil.getHTML(t)),
                      KTUtil.setHTML(t, a));
            }
        },
        btnRelease: function (t) {
            if (t) {
                KTUtil.removeAttr(t, "disabled"),
                    KTUtil.hasAttr(t, "wait-class") &&
                        KTUtil.removeClass(t, KTUtil.attr(t, "wait-class"));
                var e = KTUtil.find(t, ".btn-caption");
                e && KTUtil.data(e).has("caption")
                    ? KTUtil.setHTML(e, KTUtil.data(e).get("caption"))
                    : KTUtil.data(t).has("caption") &&
                      KTUtil.setHTML(t, KTUtil.data(t).get("caption"));
            }
        },
...
var KTWizard = function (t, e) {
    ...
    KTUtil.getBody();
    if (n) {
        var i = { startStep: 1, clickableSteps: !1, navigation: !0 },
            o = {
                construct: function (t) {
                    return (
                ...
                build: function () {
                    a.options.navigation &&
                        (KTUtil.addEvent(a.btnNext, "click", function (t) {
                            t.preventDefault(),
                                o.setNewStep(o.getNextStep()),
                                !1 !== o.eventTrigger("change") &&
                                    o.goTo(o.getNextStep());
                        }),
                        KTUtil.addEvent(a.btnPrev, "click", function (t) {
                            t.preventDefault(),
                                o.setNewStep(o.getPrevStep()),
                                !1 !== o.eventTrigger("change") &&
                                    o.goTo(o.getPrevStep());
                        }),
                ...
                goTo: function (t) {
                    if (!0 !== a.stopped) {
                        if (!(t === a.currentStep || t > a.totalSteps || t < 0))
                            return (
                                (t = parseInt(t)),
                                (a.lastStep = a.currentStep),
                                (a.currentStep = t),
                                (a.newStep = 0),
                                o.updateUI(),
                                o.eventTrigger("changed"),
                                a
                            );
                    } else a.stopped = !1;
                },
                ...
                var l = {
                    ...
                    adjustLockContainer: function () {
                        ...
                        var e = t(o.tableHead).width(),
                            a = t(o.tableHead)
                                .find(".datatable-lock-left")
                                .width(),
                            n = t(o.tableHead)
                                .find(".datatable-lock-right")
                                .width();
                        void 0 === a && (a = 0), void 0 === n && (n = 0);
                        var i = Math.floor(e - a - n);
                        return (
                            t(o.table)
                                .find(".datatable-lock-scroll")
                                .css("width", i),
                            i
                        );
                    },
                        ...
                        (o.initialDatatable = t(o).clone()),
                            "TABLE" === t(o).prop("tagName")
                                ? ((o.table = t(o)
                                  ...
                                  0 ===
                                      t(o.table).parents(".datatable").length &&
                                      (o.table.wrap(
                                          t("<div/>")
                                              .addClass("datatable")
                                              .addClass(
                                                  "datatable-" + i.layout.theme
                                              )
                                      ),
                        ...
                        if (
                            ...
                            var a = function (a) {
                                ...
                                if (
                                    ...
                                    if (
                                        t(i).find('.checkbox [type="checkbox"]')
                                            .length > 0
                                    )
                                        return;
                                    ...
                                    var o = t("<label/>")
                                        .addClass(
                                            "checkbox checkbox-single checkbox-all"
                                        )
                                        .append(
                                            t("<input/>")
                                                .attr("type", "checkbox")
                        ...
                        var e = {
                            ...
                            init: function () {
                                ...
                                if (i.layout.scroll) {
                                    ...
                                    t(r).find(".datatable-row").length > 0 &&
                                    t(r).length > 0
                                        ...
                                        : t(o.tableBody).find(".datatable-row")
                                              .length > 0 &&
                                          ((e.scrollHead = t(o.tableHead).find(
                                              "> .datatable-row"
                                          )),
                    ...
                    dataRender: function (e) {
                        ...
                        var a = function () {
                            ...
                            n = function (e) {
                                ...
                                if (
                                    (t(o.wrap).removeClass("datatable-error"),
                                    i.pagination)
                                )
                                    if (
                                        i.data.serverPaging &&
                    ...
                    insertData: function () {
                        ...
                        if (
                            ...
                            a.addClass(p, "datatable-error"),
                                ...
                                c.appendChild(p),
                                t(o.wrap).addClass(
                                    "datatable-error datatable-loaded"
                                ),
                                l.spinnerCallback(!1);
                        }
                            ...
                            .done(function (e, a, n) {
                                (o.lastResponse = e),
                                    (o.dataSet = o.originalDataSet =
                                        l.dataMapCallback(e)),
                                    l.setAutoColumns(),
                                    t(o).trigger("datatable-on-ajax-done", [
                                        o.dataSet,
                                    ]);
                            })
                            .fail(function (e, a, n) {
                        ...
                        var i = {
                            ...
                            populate: function () {
                                if (
                                    ...
                                    var n = t("<ul/>").addClass(
                                        "datatable-pager-nav my-2 mb-sm-0"
                                    );
                                    ...
                                    var p = t("<select/>")
                                            .addClass(
                                                "selectpicker datatable-pager-size"
                                            )
                                            .attr(
                                                "title",
                                                l.getOption(
                            ...
                            var a = function (a) {
                                    ...
                                    t(n).hasClass(
                                        ...
                                        ? (t(c).addClass(
                                          ...
                                          t(o).trigger(
                                              "datatable-on-collapse-subtable",
                                              [n]
                                          ))
                                        : (t(c).addClass(
                                              l.getOption(
                    ...
                    autoHide: function () {
                        ...
                        var n = function (e) {
                            ...
                            if (t(n).hasClass("datatable-row-detail"))
                                ...
                                var o = t(a)
                                    .find(".datatable-cell:hidden")
                                    .clone()
                                    .show();
                                n = t("<tr/>")
                                    .addClass("datatable-row-detail")
                                    .insertAfter(a);
                                var r = t("<td/>")
                        ...
                        setTimeout(function () {
                            t(o.table).find(".datatable-cell").show(),
                                t(o.tableBody).each(function () {
                                    for (
                                        var a = 0,
                                            n = t(this)[0].offsetWidth,
                                            r = t(this)[0].scrollWidth;
                                        n < r &&
                                        r - n > l.cellOffset &&
                                        a < i.columns.length;
                    ...
                    isSubtable: function () {
                        return (
                            a.hasClass(o.wrap[0], "datatable-subtable") || !1
                        );
                    },
                    ...
                    getTotalColumns: function (e) {
                        return (
                            ...
                            t(e)
                                .find(".datatable-row")
                                .first()
                                .find(".datatable-cell").length
                        );
                    },
                    getOneRow: function (e, a, n) {
                        void 0 === n && (n = !0);
                        var i = t(e).find(
                            ".datatable-row:not(.datatable-row-detail):nth-child(" +
                                a +
                                ")"
                        );
                        ...
                        var e = {
                            init: function () {
                                i.sortable &&
                                    (t(o.tableHead)
                                        .find(
                                            ".datatable-cell:not(.datatable-cell-check)"
                                        )
                    ...
                    rowEvenOdd: function () {
                        t(o.tableBody)
                            ...
                            t(o.wrap).hasClass("datatable-subtable")
                                ? t(o.tableBody)
                                      .find(
                                          ".datatable-row:not(.datatable-row-detail):even"
                                      )
                    ...
                    init: function () {
                        n.selectorEnabled() &&
                            ...
                            t(e).on("datatable-on-check", function (t, a) {
                                ...
                                var i = {};
                                (i.selectedRows = n.selectedRows.filter(
                                    n.unique
                                )),
                                    (i.unselectedRows = n.unselectedRows.filter(
                                        n.unique
                                    )),
                        ...
                        t(e.tableHead)
                            ...
                            .click(function (i) {
                                if (
                                    ...
                                    var o = {};
                                    (o.selectedRows = n.selectedRows.filter(
                                        n.unique
                                    )),
                                    ...
                                    t(this).is(":checked")
                                        ...
                                        !a.vars.requestIds &&
                                            ...
                                            t(e.tableHead)
                                                ...
                                                .prop("checked", !1);
                                    var l = {};
                                    (l.selectedRows = n.selectedRows.filter(
                                        n.unique
                                    )),
                                        (l.unselectedRows =
                                            n.unselectedRows.filter(n.unique)),
...
KTUtil.isRTL() &&
    ...
    KTUtil.ready(function () {
        void 0 !== KTLayoutHeader &&
            ...
            void 0 !== KTLayoutHeaderMenu &&
                KTLayoutHeaderMenu.init(
                    "kt_header_menu",
                    "kt_header_menu_wrapper"
                ),
            void 0 !== KTLayoutHeaderTopbar &&
                KTLayoutHeaderTopbar.init("kt_header_mobile_topbar_toggle"),
            void 0 !== KTLayoutBrand && KTLayoutBrand.init("kt_brand"),
            void 0 !== KTLayoutAside && KTLayoutAside.init("kt_aside"),
            void 0 !== KTLayoutAsideToggle &&
                KTLayoutAsideToggle.init("kt_aside_toggle"),
            void 0 !== KTLayoutAsideMenu &&
                KTLayoutAsideMenu.init("kt_aside_menu"),
            void 0 !== KTLayoutSubheader &&
                KTLayoutSubheader.init("kt_subheader"),
            void 0 !== KTLayoutContent && KTLayoutContent.init("kt_content"),
            void 0 !== KTLayoutFooter && KTLayoutFooter.init("kt_footer"),
            void 0 !== KTLayoutScrolltop &&
                KTLayoutScrolltop.init("kt_scrolltop"),
            void 0 !== KTLayoutStickyCard &&
                KTLayoutStickyCard.init("kt_page_sticky_card"),
            void 0 !== KTLayoutStretchedCard &&
                KTLayoutStretchedCard.init("kt_page_stretched_card"),
            void 0 !== KTLayoutExamples && KTLayoutExamples.init(),
            void 0 !== KTLayoutDemoPanel &&
                KTLayoutDemoPanel.init("kt_demo_panel"),
            void 0 !== KTLayoutChat && KTLayoutChat.init("kt_chat_modal"),
            void 0 !== KTLayoutQuickActions &&
                KTLayoutQuickActions.init("kt_quick_actions"),
            void 0 !== KTLayoutQuickNotifications &&
                KTLayoutQuickNotifications.init("kt_quick_notifications"),
            void 0 !== KTLayoutQuickPanel &&
                KTLayoutQuickPanel.init("kt_quick_panel"),
            void 0 !== KTLayoutQuickUser &&
                KTLayoutQuickUser.init("kt_quick_user"),
            void 0 !== KTLayoutQuickSearch &&
                KTLayoutQuickSearch.init("kt_quick_search"),
            void 0 !== KTLayoutQuickCartPanel &&
                KTLayoutQuickCartPanel.init("kt_quick_cart"),
            void 0 !== KTLayoutSearch &&
                KTLayoutSearch().init("kt_quick_search_dropdown"),
            void 0 !== KTLayoutSearchOffcanvas &&
...
var KTLayoutAsideMenu = (function () {
    ...
    return {
        init: function (n) {
            var i, o, l, r;
            ((t = KTUtil.getBody()), (e = KTUtil.getById(n))) &&
                ((o =
                    "1" === KTUtil.attr(e, "data-menu-dropdown")
                        ? "dropdown"
                        : "accordion"),
                "1" === KTUtil.attr(e, "data-menu-scroll") &&
                    (i = {
                        rememberPosition: !0,
                        height: function () {
    ...
    return {
        init: function (n) {
            ...
            ((e = KTUtil.getById(n)), (t = KTUtil.getBody()), e) &&
                ((i = KTUtil.hasClass(e, "aside-offcanvas-default")
                    ...
                    sticky: {
                        ...
                        position: {
                                    ...
                                    KTUtil.isBreakpointUp("lg")
                                        ? (void 0 !== KTLayoutHeader &&
                                          ...
                                          void 0 !== KTLayoutSubheader &&
                                              ...
                                              (t +=
                                                  KTLayoutSubheader.getHeight()))
                                        : void 0 !== KTLayoutHeader &&
                                          KTLayoutHeader.isFixedForMobile() &&
                                          (t +=
                                              KTLayoutHeader.getHeightForMobile()),
                                    t - 1
                                );
                            },
                            left: function (e) {
                            ...
                            right: function (e) {
                                ...
                                return (
                                    parseInt(KTUtil.css(a, "width")) -
                                    n -
                                    KTUtil.offset(t).left
                                );
                            },
                        },
                    },
    ...
    var t = function (t) {
            ...
            a &&
                (KTUtil.scrollInit(a, {
                    ...
                    height: function () {
                        var t;
                        return KTUtil.isBreakpointDown("lg")
                            ? KTUtil.hasAttr(a, "data-mobile-height")
                                ? parseInt(KTUtil.attr(a, "data-mobile-height"))
                                : 400
                            : KTUtil.isBreakpointUp("lg") &&
                              KTUtil.hasAttr(a, "data-height")
                            ? parseInt(KTUtil.attr(a, "data-height"))
                            : ((t = KTLayoutContent.getHeight()),
                              a &&
                                  (t =
                                      t -
                              ...
                              i &&
                                  (t =
                                      (t -= parseInt(KTUtil.css(i, "height"))) -
        ...
        e = function (t) {
            ...
            if (0 !== n.value.length) {
                ...
                var o,
                    l = "";
                (l += '<div class="d-flex align-items-center">'),
                    (l += "\t<div>"),
                    (l +=
                    ...
                    e.appendChild(i),
                    (n.value = ""),
                    (a.scrollTop = parseInt(KTUtil.css(e, "height"))),
                    (o = KTUtil.data(a).get("ps")) && o.update(),
                    setTimeout(function () {
                        ...
                        KTUtil.setHTML(
                            t,
                            '<div class="d-flex align-items-center">\t<div class="symbol symbol-circle symbol-40 mr-3">\t\t<img alt="Pic" src="assets/media/users/300_12.jpg"/>\t</div>\t<div>\t\t<a href="#" class="text-dark-75 text-hover-primary font-weight-bold font-size-h6">Matt Pears</a>\t\t<span class="text-muted font-size-sm">Just now</span>\t</div></div><div class="mt-2 rounded p-5 bg-light-success text-dark-50 font-weight-bold font-size-lg text-left max-w-400px">Right before vacation season we have the next Big Deal for you.</div>'
                        ),
                            e.appendChild(t),
                            (n.value = ""),
                            (a.scrollTop = parseInt(KTUtil.css(e, "height"))),
                            (i = KTUtil.data(a).get("ps")) && i.update();
                    }, 2e3);
            }
        };
    return {
                    ...
                    setTimeout(function () {
                        if (!KTCookie.getCookie("kt_app_chat_shown")) {
                            ...
                            KTCookie.setCookie("kt_app_chat_shown", 1, {
                                ...
                                KTUtil.getById("kt_app_chat_launch_btn") &&
                                    KTUtil.getById(
                    ...
                    KTUtil.scrollInit(i, {
                        ...
                        height: function () {
                            ...
                            return (
                                ...
                                n &&
                                    ((e -= parseInt(
                                        KTUtil.css(n, "marginTop")
                                    )),
                                    (e -= parseInt(
                                        KTUtil.css(n, "marginBottom")
                                    ))),
                                i &&
                                    ((e -= parseInt(
                                        KTUtil.css(i, "marginTop")
                                    )),
                                    (e -= parseInt(
                                        KTUtil.css(i, "marginBottom")
                                    ))),
                                o &&
                                    ((e -= parseInt(KTUtil.actualHeight(o))),
                                    (e -= parseInt(KTUtil.css(o, "marginTop"))),
                                    (e -= parseInt(
                                        KTUtil.css(o, "marginBottom")
                                    ))),
                                (e -= parseInt(KTUtil.css(t, "paddingTop"))),
                                (e -= parseInt(
                                    KTUtil.css(t, "paddingBottom")
                                )) - 2
                            );
                        },
                    }),
                    ...
                    i &&
                        new ClipboardJS(i, {
                            target: function (t) {
                                ...
                                return (
                                    a || (a = KTUtil.find(e, ".example-code")),
                                    a
                                );
                            },
                ...
                KTUtil.scrollInit(n, {
                    ...
                    height: function () {
                        ...
                        return (
                            ...
                            (e -= parseInt(KTUtil.css(t, "paddingTop"))),
                            (e -= parseInt(KTUtil.css(t, "paddingBottom"))) - 2
                        );
                    },
                }));
        },
...
var KTLayoutSearch = function () {
    var t,
        ...
        v = function () {
            if (d && s === a.value)
                return (
                    g(), KTUtil.addClass(t, f), m(), void KTUtil.scrollUpdate(i)
                );
            (s = a.value),
    ...
    return {
        init: function (s) {
            (t = KTUtil.getById(s)) &&
                ...
                KTUtil.addEvent(a, "keyup", T),
                KTUtil.addEvent(a, "focus", T),
